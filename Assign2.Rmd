...
$Anti_{ti} = \beta_{00} + \beta_{10} T_{ti} + u_{0i} + e_{ti}$
...
$R^2_{Level2} = \frac{\sigma^2_{u0(model2)} - \sigma^2_{u0(model3)}}{\sigma^2_{u0(model2)}} = \frac{1.592 - 1.592}{1.592} = 0.01$
...
$R^2_{Level2} = \frac{\sigma^2_{u0(model2)} - \sigma^2_{u0(model4a)}}{\sigma^2_{u0(model2)}} = \frac{1.592 - 1.592}{1.592} = 0.01$
...
\textbf{Deviance difference}  & 26.561$^{***}$ & 0.26 \\
\bottomrule
\multicolumn{3}{l}{Note}\\
$^{***} p<.001, ^{**} p<.01$ \\
\end{tabular}
...
$$Anti_{ti} = \pi_{0i} + \pi_{1i}T_{ti} + e_{ti}$$

Equation of level 2:

$$\pi_{0i} = \beta_{00} + \beta_{01}homecog + u_{0i}$$

$$\pi_{1i} = \beta_{10} + \beta_{11}homecog + u_{1i}$$

Mixed Model Equation :

$$Anti_{ti} = \beta_{00} + \beta_{01}homecog + \beta_{10}T_{ti} + \beta_{11}homecog*time + u_{0i} + u_{1i}T_{ti} + e_{ti}$$
