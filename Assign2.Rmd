...
- with each one point increase in *time* (each measurement occasion), the expected *antisocial behavior* score goes up by 0.18, when *homecog* is kept constant, that is when comparing within children who have the same *cognitive stimulation* score;

- with each one unit increase in *cognitive stimulation*, the expected *anti* score decreases by 0.13, when *time* is kept constant, that is when comparing children within the same measurement occasion. 
