...
- with each one point increase in *cognitive stimulation*, the coefficient for *time* decreases by 0.05. This means that the rate of change in *antisocial behavior* over time is smaller for children who received more *cognitive stimulation* than for children with lower score on this variable.

*Cognitive stimulation* is not significant, $b_{homecog}=-0.06, t(221)=-1.49, p > .05$.

We obtained a better-fitting model compared to the model without the slope predictors, 5a, $χ^2(1) = 6.88$, $p<.05$. Therefore, model_6b is our final model.
...
According to the Q-Q plots, since the distribution of the residuals in level-1 and level-2 roughly fit to the diagonal line. We confirm that the normality of both level-1 and level-2 residuals hold.
