...
```{r, message=FALSE, echo=FALSE, fig.width=3.5, fig.height=8, fig.cap = "Scatterplots for the first level by individuals", fig.topcaption=TRUE}
...
```{r, message=FALSE, echo=FALSE, fig.align='center', fig.cap = "Scatterplot for cognitive stimulation and antisocial behavior", fig.topcaption=TRUE}
...
```{r, message=FALSE, echo=FALSE, fig.align='center',fig.cap = "Scatterplot for mother's age and antisocial behavior", fig.topcaption=TRUE}
...
Adding *mother's age* as a predictor of slope for *time* does not improve the model and this variable does not moderate the relation between *time* and *antisocial behavior* nor does it explain the differences in *antisocial behavior* at the first occasion. 
